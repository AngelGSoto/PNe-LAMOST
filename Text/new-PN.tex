...
find the best-fitting model, which is given,
...
usually between 1 and 2. The flux lines of each line were measured  interactively by fitting a 1D Gaussian using the 10 $\AA$ centered on
...
under the line and $𝐷 = 1.0009 \AA$ pixel$^{-1}$ is the spectral dispersion. 
