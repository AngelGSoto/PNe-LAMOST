...
Two types of galactic objects show high excitation
...
This was made by implementing the python package \texttt{dust\_extinction}\footnote{\url{https://dust-extinction.readthedocs.io/en/stable/#}}. This produced more than 40$\times10^3$ models.
...
the number 9 in sum symbol indicates the number of parameters used to estimate the  $\chi^{2}$ value. In this case, are the 9 flux lines, that we are used because are the most intense.
This lines are [Ne III] 3967.470, H$\delta$, H$\gamma$, He II 4685.99, H$\beta$, [O III] 4958.911,
