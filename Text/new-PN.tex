...
Given the small number of observational constraints, weadopt a very simple model of a planetary nebula which
...
which was used to create a set of input of model and lead with the  output files. 
...
\label{sec:best-fit}
In order to chose the final model
...
calculating $\chi^{2}$, and  $\chi^{2}_{r}$
