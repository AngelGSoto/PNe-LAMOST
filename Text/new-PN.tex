...
The spectrum was modelled by using the {\sc cloudy} photo-ionization code version
c22.01 \citep{Ferland:2017}. The code uses a set of input parameters to compute the
