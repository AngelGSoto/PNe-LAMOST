...
\begin{abstract}
  ...
  including highly ionized {\sc Bla Bla Bla Bla}
...
are mapped a large are of the sky.
This means that many of emission line objects could be observed for the broad-band
survey and not for the narrow ones. This means that many emission line objects could have been observed for broadband surveys and not for narrowband ones. So, we thought that creating a
color-color diagram based on these surveys to select these objects could allow us to find
...
\caption{Diagram \((G - r)\) versus \((G_{BP} - G_{RP})\) combining the GAIA and Pan-STARRS1 photometry.
  ...
  catalog of central star of \citet{Gonzalez:2021} are represented by the dark green symbols, orange contours represents the position of the 
...
\centering
  ...
  \caption{As Figure \ref{fig:gaia-ps} but with the objects classified as PN candidate from the list of emission line objects of \citet{Skoda:2020}.} 
