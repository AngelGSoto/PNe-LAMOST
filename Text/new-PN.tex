...
spectrum of NGC 2242, so we first adopted the abundances of it and after we change the value of He and Ar to get a better match with the observed spectra. We also adopted inner and outer radius
of that showed very good. For the distance we implemented the distance of the central star of the PNe estimated by \citet{Bailer:2021} based on
