...
**** Paper using CLOUDY
    - [[https://iopscience.iop.org/article/10.1088/0004-6256/140/5/1347/pdf][Helton et al.]]
    - [[https://arxiv.org/pdf/2207.10473.pdf][Pandey et al.]]
    - [[https://ui.adsabs.harvard.edu/abs/2018MNRAS.474.4211M/abstract][Mondal et al.]]
    - [[https://ui.adsabs.harvard.edu/abs/2019A%26A...622A.126P/abstract][Pavana et al.]]
    - [[https://ui.adsabs.harvard.edu/abs/2020MNRAS.492.2326M/abstract][Mondal el al.]]
    - [[https://ui.adsabs.harvard.edu/abs/2022ApJ...925..187P/abstract][Pandey et al.]]
    - [[https://arxiv.org/pdf/1807.01787.pdf][Barria et al.]]
...
** images
   ...
   - New program using the denoise package:
     : python ../programs/rgb_image-ps1-denoise.py cutout_rings_v3_skycell_2294_031_stk_i_unconv cutout_rings_v3_skycell_2294_031_stk_r_unconv cutout_rings_v3_skycell_2294_031_stk_g_unconv --vmin_r -443.4 --vmax_r 5000 --vmin_g -200 --vmax_g 2500 --vmin_b -250.93 --vmax_b 2000 --debug 

   - The panstarr image of the PN candidate is 29.062 arcsec.
...
** Cloudy models
   *** Some paper modeling PN
   [[https://www.aanda.org/articles/aa/pdf/2013/01/aa19263-12.pdf][S.-J. Lee and S. Hyung]]
   ...
   - I include the reddening, Ev = [0, 0.1, 0.2.. 1.0].
     : for f in *.in; do python ../../../programs/redenned.py ${f%.in}; done
     
*** First comments
    
    - Dens 3000 -> The model N2242 _130000_37.51. Seem the best fit.
    - Dens 3000 -> DdDm1 _130000_37.48. But two line apperars in 6400 and 6500 A.

    - I drop out of the power law for the resolution, the improvement was quite better.
      Now I think that the best fit is, N2242_120000_37.58.
    - Now change the He abundance in He of N2242, I used -0.8. Very nice improvement see model_140000_37.57.
    - Change Ar = -6.24.
    - Using radius 16.6030 17.05, very similar result: 140000_36.86

*** Measurements flux line

    I used the ==specultis== to measurement the flux line. I used it to fit 1D Gaussian and integrated the flux.
    What about of the uncertainty? Here some papers, [[https://articles.adsabs.harvard.edu/pdf/1999MNRAS.310..262T][Tresse et. al.]] and [[https://www.aanda.org/articles/aa/full/2002/47/aa2895/node3.html][this]].
...
----------------------- ------------------ -----------------
model_130000_37.03_3.54 23.485306363271494 3.914217727211916
       Name model              chi              Chi red      
----------------------- ------------------ ------------------
model_130000_37.12_3.60 23.904325009487284 3.9840541682478805
       Name model              chi              Chi red     
----------------------- ------------------ -----------------
model_130000_37.22_3.70 23.070701698849014 3.845116949808169
       Name model              chi              Chi red     
----------------------- ------------------ -----------------
model_130000_37.27_3.74 22.620381864506573 3.770063644084429
       Name model              chi              Chi red      
----------------------- ------------------ ------------------
model_130000_37.32_3.78 22.411742734577704 3.7352904557629505
       Name model              chi              Chi red     
----------------------- ------------------ -----------------
model_140000_37.15_3.70 23.857530904674757 3.976255150779126
       Name model              chi              Chi red      
----------------------- ------------------ ------------------
model_140000_37.22_3.74 23.178786493244182 3.8631310822073637
       Name model              chi              Chi red      
----------------------- ------------------ ------------------
model_140000_37.27_3.78 23.923062736725495 3.9871771227875823
       Name model              chi             Chi red      
----------------------- ----------------- ------------------
model_150000_37.22_3.78 23.85684015614496 3.9761400260241597
#+end_example

** About the LMAOST spectra
   A paper that apeak about the blue and red arm of the LAMOST spectra:
   [[https://iopscience.iop.org/article/10.3847/0004-6256/152/2/45/pdf][Bingqiu Chen et al]]
